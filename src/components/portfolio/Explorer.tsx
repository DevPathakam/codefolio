...
export const Explorer = () => {
  ...
  return (
    showSidebar && (
      <nav className="font-jetbrains-mono w-65 h-full bg-brand-primary-deep-dark flex justify-between flex-col border-r border-r-brand-border select-none absolute md:relative z-20 top-0 left-0 pb-6">
